...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	// DCAN FIFO Assignment
	HAL_CAN_ActivateNotification(&hcan1, CAN_IT_RX_FIFO0_MSG_PENDING);

	// BMS CAN FIFO Assignment
	//BMS_can is a stand alone master so has access to both fifo's
//	HAL_CAN_ActivateNotification(&hcan2, CAN_IT_RX_FIFO0_MSG_PENDING); TODO Still investigating FIFO0/1 need
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, GREEN_LED_Pin|ORANGE_LED_Pin|RED_LED_Pin|BLUE_LED_Pin 
                          |GPIO_WWDG_EN_Pin|WDI_Pin|SDC_BMS_FAULT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GREEN_LED_Pin ORANGE_LED_Pin RED_LED_Pin BLUE_LED_Pin 
                           GPIO_WWDG_EN_Pin WDI_Pin SDC_BMS_FAULT_Pin */
